...
export function Co2Icon({ size = 14, className }: { size?: number; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
...
const GLYPH: Record<ConditionCategory, ReactNode> = {
  ...
  cloud: <path d="M17.5 19a4.5 4.5 0 0 0 0-9 6 6 0 0 0-11.6 2.1A3.5 3.5 0 0 0 6.5 19z" />,
  rain: (
    <>
