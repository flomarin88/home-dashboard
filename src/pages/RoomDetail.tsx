...
import { formatSensorValue, co2ColorClass } from '../widgets/room-sensor-format'
import { SPARKLINE_HOURS, TEMP_REFERENCE_LINES, CO2_REFERENCE_LINES } from '../config'
  ...
  return (
    <div className="flex flex-col gap-2 overflow-hidden rounded-md border border-tile-border bg-tile-fill p-4">
      <div className="flex items-baseline justify-between gap-2">
        <span className="text-label font-semibold text-text-muted">{cfg.title}</span>
        <span
